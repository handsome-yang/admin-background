              ...
              <div class="content">
                <el-row>
                  <el-col :xs="24" :sm="12" :md="12" :lg="8">
                    ...
                    >
                      <el-input
                        v-model="form.driver_contact.team_name"
                        placeholder="车队编号"
                        clearable
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="12" :md="12" :lg="8">
                    ...
                    >
                      <el-input
                        v-model="form.driver_contact.car_number"
                        placeholder="车辆编号"
                        clearable
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :xs="24" :sm="12" :md="12" :lg="8">
                    ...
                    >
                      <el-input
                        v-model="form.driver_contact.driver_name"
                        placeholder="联系人"
                        clearable
                      ></el-input>
                    </el-form-item>
